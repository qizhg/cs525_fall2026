...
\end{align}
\underline{\em For Homework 3's 1a, provide a justification for \eqref{eq:Delta_hat_i}.}
...
\end{align}
\underline{\em For Homework 3's 1b, provide a justification for \eqref{eq:Hoeffding_upper}.}
...
\label{eq:UCB-bad_event}
    ...
    .
\end{align}
\underline{\em For Homework 3's 1c, provide a justification for \eqref{eq:UCB-bad_event}} (Hint: Use the union bound over all possible values that $N_{i, t-1}=n$ can take).
...
\underline{\em For Homework 3's 1d, provide a justification for the two inequalities in \eqref{eq:UCB-regret_decomposition}}.
