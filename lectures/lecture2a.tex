\title{Lecture 2a: Generative Models - Monte Carlo Tree Search}
\author{Qi Zhang}
...
Sections \ref{sec:AlphaGo Zero} and \ref{sec:UCT} respectively discuss two well-known instantiations from this template, UCT and AlphaZero.
...
\begin{align*}
    \argmax_{a\in\mathcal{A}} \quad {\rm UCB}(\tau,a):= \frac{G^{\rm total}_{\tau,a}}{N_{\tau,a}} + c\sqrt{\frac{\ln(N_\tau)}{N_{\tau,a}}}
\end{align*}
